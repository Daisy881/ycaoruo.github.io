...
=======
  address: {
    ...
    addAddress: 'insert into address_info (id, username, cname, cPhone, shippingAddress, detailAddress, defaultAddress) values (null, ?, ?, ?, ?, ?, ?)',
    editAddress: 'update address_info set cname=?, cPhone=?, shippingAddress=?, detailAddress=?, defaultAddress=? where id=?',
    editAddressDefault: 'update address_info set defaultAddress=? where id=?',
    delAddress: 'delete from address_info where id=?',
